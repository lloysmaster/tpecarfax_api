...
// ➡️ GET /vehicles (Obtener todos los vehículos
...
// ➡️ GET /vehicles/:id (Obtener un vehículo por ID)
...
// ➡️ POST /vehicles (Crear un nuevo vehículo)
$router->addRoute('vehicles', 'POST', 'VehicleApiController', 'create');

// ➡️ PUT /vehicles/:id (Actualizar un vehículo por ID)
$router->addRoute('vehicles/:ID', 'PUT', 'VehicleApiController', 'update');

// ➡️ DELETE /vehicles/:id (Borrar un vehículo por ID)
...
// 4. Le pides a la librería que procese la solicitud actual
// Este método (route) es el que analiza la URL, el método HTTP,
